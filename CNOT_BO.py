...
from estimators import QiskitAnsatz, QiskitEstimator
...
unoptimised_pf, unoptimised_zf = est_circ.evaluate_process_zero_fidelities(params=[0.0]*18)

print(unoptimised_pf)
print(unoptimised_zf)

best_seen_pf, best_seen_zf = est_circ.evaluate_process_zero_fidelities(params=list(x_seen))

print(best_seen_pf)
print(best_seen_zf)

best_exp_pf, best_exp_zf = est_circ.evaluate_process_zero_fidelities(params=list(x_exp))
